...
<div class="container-fluid mb-5">
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 d-flex flex-row justify-content-center gap-0 gap-lg-5 p-4 p-lg-0">
        <div class="col">
            <h4 class="text-dark mt-4 fw-bold">BenerinAja.my.id</h4>
            <ul class="list-group gap-2" style="list-style-type: none; padding-left: 0;">
              ...
              <li><a href="index.php#form" class="text-decoration-none text-dark footer-link">PRICING</a></li>
              <li><a href="index.php#testimony" class="text-decoration-none text-dark footer-link">TESTIMONY</a></li>
